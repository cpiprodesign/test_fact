<template>
    <div class="card card-collapsed">
        <div class="card-header bg-info">
            <h3 class="my-0">Listado de Marcas</h3>
...
<!--                <a href="#" class="card-action card-action-dismiss text-white" data-card-dismiss=""></a>-->
        ...
        <trademark-form :showDialog.sync="showDialog" :recordId="recordId"></trademark-form>
...
<script>
    ...
    import TrademarkForm from './form.vue'
    import {deletable} from '../../../mixins/deletable'

    export default {
        mixins: [deletable],
        components: {TrademarkForm},
        data() {
            return {
